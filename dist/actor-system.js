...
export class ActorSystem {
    ...
    constructor(config = {}) {
        ...
        this.userGuardian = new ActorCell(this, null, { receive: () => { } }, 'user', this.defaultDispatcher, this.config.defaultThroughput);
...
//# sourceMappingURL=actor-system.js.map