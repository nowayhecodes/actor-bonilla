 ...
 */ export class FSM {
    ...
    /** Set the initial state and data. */ initialState(state, data) {
        this._initialState = state;
        this._initialData = data;
        return this;
    }
    /** Register a handler for a state. */ when(state, handler) {
        this.handlers.set(state, handler);
        return this;
    }
    /** Set a timeout for a specific state. */ stateTimeout(state, timeoutMs) {
        this._stateTimeouts.set(state, timeoutMs);
        return this;
    }
    /** Register a transition listener. */ onTransition(handler) {
        this.transitionListeners.push(handler);
        return this;
    }
    /** Build Props for the FSM actor. */ build() {
