...
export type BeforeRequestHook = (options: NormalizedOptions) => void | NormalizedOptions | Promise<void | NormalizedOptions>;
export type AfterResponseHook = (response: HttpResponse, retryWithMergedOptions: (options: Partial<Options>) => Promise<never>) => HttpResponse | Promise<HttpResponse>;
export type BeforeErrorHook = (error: RequestError) => RequestError | Promise<RequestError>;
export type BeforeRetryHook = (state: BeforeRetryState) => void | Promise<void>;
export type BeforeRedirectHook = (updatedOptions: NormalizedOptions, response: Response) => void | Promise<void>;
export type InitHook = (plain: Partial<Options>, options: NormalizedOptions) => void;
...
export interface PaginationOptions<T = unknown> {
     ...
     */
    paginate?: (response: HttpResponse, allItems: T[], currentItems: T[]) => Partial<Options> | false | Promise<Partial<Options> | false>;
...
export interface Options {
    ...
    searchParams?: string | URLSearchParams | Record<string, string | number | boolean> | [string, string | number | boolean][];
...
export declare const HTTP_PROGRESS_CHANNEL: unique symbol;
export declare const HTTP_REQUEST_CHANNEL: unique symbol;
export declare const HTTP_RESPONSE_CHANNEL: unique symbol;
export declare const HTTP_ERROR_CHANNEL: unique symbol;
...
export declare class RequestError extends Error {
    ...
    constructor(message: string, options: NormalizedOptions, code?: string, response?: HttpResponse);
}
