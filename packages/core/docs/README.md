...
| Guide | Contents |
|-------|----------|
| [Getting started](./getting-started.md) | Install, module format, minimal actor example |
...
The [top-level README](../README.md) stays short on purpose; deeper detail lives here.
