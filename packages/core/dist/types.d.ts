...
export type Receive<T> = (message: T, context: ActorContext<T>) => void | Promise<void>;
...
export declare function props<T>(receive: Receive<T>, options?: Partial<Omit<Props<T>, 'receive'>>): Props<T>;
export declare enum SupervisionDirective {
    Resume = "resume",
    Restart = "restart",
    Stop = "stop",
    Escalate = "escalate"
...
export declare function allForOneStrategy(maxRetries: number, withinMs: number, decider: (error: Error) => SupervisionDirective): SupervisionStrategy;
export declare const PreStart: unique symbol;
export declare const PostStop: unique symbol;
export declare const PreRestart: unique symbol;
export declare const PostRestart: unique symbol;
export declare const Terminated: unique symbol;
export declare const PoisonPill: unique symbol;
export declare const Kill: unique symbol;
export declare const ReceiveTimeout: unique symbol;
export interface TerminatedMessage {
    readonly signal: typeof Terminated;
    readonly ref: ActorRef<any>;
}
export type LifecycleSignal = typeof PreStart | typeof PostStop | typeof PreRestart | typeof PostRestart;
